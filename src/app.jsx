...
// Storage polyfill — runs after imports, safe for ES modules
if (typeof window !== 'undefined' && !window.storage) {
  window.storage = {
    ...
    list: async (prefix) => { try { const keys = Object.keys(localStorage).filter(k2 => !prefix || k2.startsWith(prefix)); return { keys }; } catch { return { keys: [] }; } }
  };
}
...
// Dynamic today ÃÂ¢ÃÂÃÂ find which slot in the week strip matches today
const _now = new Date();
...
const BID_STATUS = {
  NEW:       { color:"#F59E0B", bg:"#1c100388", label:"New",       icon:"ÃÂ°ÃÂÃÂÃÂ" },
  REVIEWING: { color:"#3B82F6", bg:"#1e3a5f88", label:"Reviewing", icon:"ÃÂ°ÃÂÃÂÃÂ" },
  BIDDING:   { color:"#A78BFA", bg:"#1e1b4b88", label:"Bidding",   icon:"ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ" },
  SUBMITTED: { color:"#10B981", bg:"#052e1688", label:"Submitted", icon:"ÃÂ°ÃÂÃÂÃÂ¤" },
  WON:       { color:"#10B981", bg:"#052e1699", label:"Won ÃÂ°ÃÂÃÂÃÂ",    icon:"ÃÂ°ÃÂÃÂÃÂ" },
  LOST:      { color:"#374151", bg:"#11182799", label:"Lost",       icon:"ÃÂ¢ÃÂÃÂ" },
  DECLINED:  { color:"#EF4444", bg:"#45090a88", label:"Declined",  icon:"ÃÂ°ÃÂÃÂÃÂ«" },
};
const PEOPLE = ["David","Hannah","Annie","Britney","Elma","Claude","Roger","Hugo","Assign ÃÂ¢ÃÂÃÂ"];

// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
// SEED DATA ÃÂ¢ÃÂÃÂ 3 REAL BIDS FROM INBOX
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
const SEED_TASKS = [
  { id:1,  icon:"ÃÂ°ÃÂÃÂÃÂ·", title:"Director of Construction",   subtitle:"Shortlist resumes ÃÂ¢ÃÂÃÂ begin interviews",            domain:"Business", priority:1,  status:"ACTIVE",    owner:"David",    deadline:"ASAP",      day:"MON", progress:10, nextAction:"Send resumes to Claude for scoring & ranking",    dateAdded:"2026-03-09" },
  { id:2,  icon:"ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ", title:"Soletta Project Setup",      subtitle:"File structure, job account, materials, trailer", domain:"Business", priority:2,  status:"ACTIVE",    owner:"Assign ÃÂ¢ÃÂÃÂ", deadline:"This Week", day:"MON", progress:20, nextAction:"Name the owner for job account + materials ÃÂ¢ÃÂÃÂ NOW", dateAdded:"2026-03-09" },
  { id:11, icon:"ÃÂ°ÃÂÃÂÃÂ", title:"FrankCrum PEO ÃÂ¢ÃÂÃÂ Due Mar 12", subtitle:"Loss runs + enrollment must close by Mar 12",     domain:"Business", priority:1,  status:"ACTIVE",    owner:"David",    deadline:"Mar 12",    day:"TUE", progress:60, nextAction:"Confirm loss runs sent to Tami Collinsworth",      dateAdded:"2026-03-09" },
  { id:5,  icon:"ÃÂ°ÃÂÃÂÃÂ¡", title:"Land + Construction Loan",   subtitle:"Requirements, timeline, Q2 possession plan",      domain:"Personal", priority:5,  status:"ACTIVE",    owner:"David",    deadline:"EOQ2",      day:"TUE", progress:5,  nextAction:"Tell Claude: what county? One home or compound?", dateAdded:"2026-03-09" },
  { id:3,  icon:"ÃÂ°ÃÂÃÂÃÂ", title:"2026 Coastal Budget",         subtitle:"Revenue targets, overhead, margin analysis",      domain:"Business", priority:3,  status:"QUEUED",    owner:"David",    deadline:"This Week", day:"WED", progress:0,  nextAction:"Block 90 min Wednesday to build the framework",   dateAdded:"2026-03-09" },
  { id:7,  icon:"ÃÂ¢ÃÂÃÂ¾", title:"Reagan's Softball",           subtitle:"Next game ÃÂ¢ÃÂÃÂ is David making it?",                 domain:"Family",   priority:7,  status:"RECURRING", owner:"David",    deadline:"Weekly",    day:"WED", progress:0,  nextAction:"Confirm next game time and block calendar now",   dateAdded:"2026-03-09" },
  { id:10, icon:"ÃÂ¢ÃÂÃÂÃÂ¯ÃÂ¸ÃÂ", title:"Davis Reed / K-1 Dispute",   subtitle:"Book corrections, amended returns 2022ÃÂ¢ÃÂÃÂ2024",     domain:"Business", priority:10, status:"WAITING",   owner:"Britney",  deadline:"ASAP",      day:"THU", progress:35, nextAction:"Confirm Britney finished reclassifications",      dateAdded:"2026-03-09" },
  { id:12, icon:"ÃÂ°ÃÂÃÂÃÂ»", title:"BuilderTrend vs Jobtread",    subtitle:"Decision deadline end of week",                   domain:"Business", priority:3,  status:"ACTIVE",    owner:"David",    deadline:"Mar 13",    day:"FRI", progress:0,  nextAction:"Stop deferring ÃÂ¢ÃÂÃÂ make the call by Friday",        dateAdded:"2026-03-09" },
  { id:8,  icon:"ÃÂ°ÃÂÃÂÃÂ", title:"Daily Steps",                 subtitle:"3,000 avg ÃÂ¢ÃÂÃÂ 10,000 goal",                         domain:"Health",   priority:8,  status:"RECURRING", owner:"David",    deadline:"Daily",     day:"MON", progress:30, nextAction:"Log yesterday's steps right now",                 dateAdded:"2026-03-09" },
  { id:4,  icon:"ÃÂ°ÃÂÃÂ§ÃÂ¾", title:"Receipt Capture App",         subtitle:"Forward receipts ÃÂ¢ÃÂÃÂ auto-route to accounting",    domain:"Business", priority:4,  status:"QUEUED",    owner:"Claude",   deadline:"Next Week", day:null,  progress:0,  nextAction:"Confirm priority ÃÂ¢ÃÂÃÂ this week or next?",           dateAdded:"2026-03-09" },
  { id:6,  icon:"ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ", title:"Family Compound Plan",        subtitle:"In-laws + Britney ÃÂ¢ÃÂÃÂ legal, financial, emotional", domain:"Personal", priority:6,  status:"QUEUED",    owner:"Britney",  deadline:"EOY",       day:null,  progress:0,  nextAction:"Schedule a dedicated brainstorm ÃÂ¢ÃÂÃÂ not this week", dateAdded:"2026-03-09" },
  { id:9,  icon:"ÃÂ°ÃÂÃÂÃÂ", title:"Reagan's 5th Birthday",       subtitle:"April 26 ÃÂ¢ÃÂÃÂ planning is overdue",                  domain:"Family",   priority:9,  status:"QUEUED",    owner:"Britney",  deadline:"Apr 26",    day:null,  progress:0,  nextAction:"Party at home or venue? Text Britney today.",     dateAdded:"2026-03-09" },
];
...
const SEED_BIDS = [
  {
    ...
    projectName: "Kay Jeweler's ÃÂ¢ÃÂÃÂ Orlando, FL",
    projectAddress: "753 N. Alafaya Trail, H05, Orlando, FL 32828",
    scope: "2,182 sqft ÃÂÃÂ· Retail Upfit",
    trades: "Div. 15 ÃÂ¢ÃÂÃÂ Plumbing, Fire Protection, HVAC",
  ...
  },
  {
    ...
    projectName: "Aldi #2503 ÃÂ¢ÃÂÃÂ Wesley Chapel, FL",
    projectAddress: "27301 Wesley Chapel, FL 33544",
    scope: "Retrofit ÃÂÃÂ· All Trades",
    trades: "All Trades ÃÂ¢ÃÂÃÂ Plumbing included",
    bidDue: "2026-03-24T19:00:00.000Z",   // Mar 24 2:00 PM ET (extended)
    projectStart: "",
    docsLink: "",
    status: "NEW",
    assignedTo: "Assign ÃÂ¢ÃÂÃÂ",
    notes: "Bid date extended from original ÃÂ¢ÃÂÃÂ addendum pending. PDF bids to estimating@casecontracting.com",
    receivedDate: "2026-03-09",
  ...
  },
  {
    ...
    rfiEmail: "",
    projectName: "Starbucks ÃÂ¢ÃÂÃÂ Coconut Point Outlets",
    projectAddress: "8076 Mediterranean Dr, Estero, FL 33928",
    scope: "Retail ÃÂÃÂ· All Trades",
    trades: "Plumbing",
...
// Map Firebase task format ÃÂ¢ÃÂÃÂ app task format
function mapFirebaseTask(t) {
  const iconMap = {Business:"ÃÂ°ÃÂÃÂÃÂ",Personal:"ÃÂ°ÃÂÃÂÃÂ¹",Family:"ÃÂ°ÃÂÃÂÃÂ",Health:"ÃÂ°ÃÂÃÂÃÂª"};
  return {
    id:         t.id || String(Date.now() + Math.random()),
    icon:       iconMap[t.domain] || "ÃÂ°ÃÂÃÂÃÂ",
...
async function fbWriteTasks(tasks) {
  ...
  } catch { /* silent fail ÃÂ¢ÃÂÃÂ local state is still intact */ }
}
...
// API CALLERS
// ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ
async function fetchCalendarEvents() { return []; }

async function scanBidEmails() { return []; }

async function scanTaskEmails() { return []; }
  ...
  return (
    <div style={{position:"fixed",inset:0,background:"#060a12f8",backdropFilter:"blur(14px)",zIndex:2000,display:"flex",flexDirection:"column"}}>
      ...
      <div style={{background:"#0a0f1c",borderBottom:"1px solid #1e2d4a",padding:"14px 16px",display:"flex",alignItems:"center",gap:10,flexShrink:0}}>
        ...
        <button onClick={onClose} style={{width:32,height:32,borderRadius:"50%",background:"#131e30",border:"1px solid #1e2d4a",color:"#64748B",fontSize:14,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>ÃÂ¢ÃÂÃÂ</button>
      </div>
      ...
      <div style={{flex:1,overflowY:"auto",padding:"16px 16px 80px"}}>
        ...
        <div style={{display:"flex",gap:10,padding:"14px",background:"#0a0f1c",border:`1px solid ${uc}33`,borderRadius:12,marginBottom:14}}>
          ...
          {days!==null&&(
            <div style={{textAlign:"center",background:uc+"18",border:`1px solid ${uc}44`,borderRadius:10,padding:"10px 16px",minWidth:64}}>
              <div style={{fontSize:30,fontWeight:900,color:uc,lineHeight:1}}>{days<0?"ÃÂ¢ÃÂÃÂ ":days}</div>
        ...
        {/* Info rows */}
        {[
          {label:"Address",  val:local.projectAddress, icon:"ÃÂ°ÃÂÃÂÃÂ"},
          {label:"Scope",    val:local.scope,           icon:"ÃÂ°ÃÂÃÂÃÂ"},
          {label:"Trades",   val:local.trades,          icon:"ÃÂ°ÃÂÃÂÃÂ§"},
          {label:"GC Email", val:local.gcEmail,         icon:"ÃÂ°ÃÂÃÂÃÂ§"},
          {label:"GC Phone", val:local.gcPhone,         icon:"ÃÂ°ÃÂÃÂÃÂ"},
          {label:"RFI To",   val:local.rfiEmail,        icon:"ÃÂ¢ÃÂÃÂ"},
          {label:"Docs",     val:local.docsLink,        icon:"ÃÂ°ÃÂÃÂÃÂ"},
        ...
        <div style={{marginBottom:12}}>
          ...
          <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
            {["David","Hannah","Annie","Britney","Assign ÃÂ¢ÃÂÃÂ"].map(p=>(
    ...
    <div style={{position:"fixed",inset:0,background:"#060a12f8",backdropFilter:"blur(14px)",zIndex:1500,display:"flex",flexDirection:"column"}}>
      <div style={{background:"#0a0f1c",borderBottom:"1px solid #1e2d4a",padding:"14px 16px",display:"flex",alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
        <div>
          ...
          <div style={{fontSize:17,fontWeight:900}}>ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ Scan for New Bids</div>
        </div>
        <button onClick={onClose} style={{padding:"6px 14px",borderRadius:8,background:"#131e30",border:"1px solid #1e2d4a",color:"#64748B",fontSize:12,cursor:"pointer"}}>ÃÂ¢ÃÂÃÂ Close</button>
      </div>

      <div style={{flex:1,overflowY:"auto",padding:"24px 16px 80px"}}>
        {phase==="idle"&&(
          <div style={{textAlign:"center",paddingTop:48}}>
            <div style={{fontSize:56,marginBottom:20}}>ÃÂ°ÃÂÃÂÃÂ¬</div>
            <div style={{fontSize:16,fontWeight:800,marginBottom:12}}>Scan for Bid Invitations</div>
            <div style={{fontSize:12,color:"#475569",lineHeight:1.8,marginBottom:36,maxWidth:260,margin:"0 auto 36px"}}>Searches your inbox for "Invitation to Bid", "ITB", "bid date" ÃÂ¢ÃÂÃÂ reads the full details and drops them onto your Estimating Calendar.</div>
            <button onClick={runScan} style={{padding:"14px 32px",borderRadius:10,background:"#F59E0B",border:"none",color:"#000",fontSize:14,cursor:"pointer",fontWeight:900}}>Scan Inbox ÃÂ¢ÃÂÃÂ</button>
          </div>
        )}
        {phase==="scanning"&&(
          <div style={{textAlign:"center",paddingTop:60}}>
            <div style={{fontSize:48,display:"inline-block",marginBottom:20,animation:"spin 2s linear infinite"}}>ÃÂ°ÃÂÃÂÃÂ</div>
        ...
        {phase==="error"&&(
          <div style={{textAlign:"center",paddingTop:60}}>
            <div style={{fontSize:48,marginBottom:16}}>ÃÂ¢ÃÂÃÂ ÃÂ¯ÃÂ¸ÃÂ</div>
        ...
        {phase==="review"&&(
          <>
            <div style={{marginBottom:18,padding:"12px 14px",background:"#0f1724",border:"1px solid #F59E0B33",borderRadius:10}}>
              ...
              <div style={{fontSize:10,color:"#475569"}}>Tap <span style={{color:"#10B981",fontWeight:700}}>Add</span> to put on the calendar ÃÂÃÂ· <span style={{color:"#EF4444",fontWeight:700}}>Skip</span> to dismiss</div>
            </div>
            {suggs.map((s,i)=>{
              ...
              return(
                <div key={i} style={{marginBottom:10,opacity:isDismissed?0.3:1,transition:"opacity 0.2s"}}>
                  <div style={{background:"#0c1220",border:`1px solid ${isDismissed?"#1e2d4a":uc+"44"}`,borderLeft:`3px solid ${isDismissed?"#374151":uc}`,borderRadius:10,padding:"12px 12px 10px"}}>
                    ...
                    {s.projectAddress&&<div style={{fontSize:9,color:"#475569",marginBottom:4}}>ÃÂ°ÃÂÃÂÃÂ {s.projectAddress}</div>}
                    {s.trades&&<div style={{fontSize:9,color:"#3B82F6",marginBottom:8}}>ÃÂ°ÃÂÃÂÃÂ§ {s.trades}</div>}
                    ...
                    {!isDismissed?(
                      <div style={{display:"flex",gap:8}}>
                        <button onClick={()=>{dismiss(i);onAddBids([s]);}} style={{flex:2,padding:"9px",borderRadius:8,background:"#052e16bb",border:"1px solid #10B98166",color:"#10B981",fontSize:12,cursor:"pointer",fontWeight:800}}>ÃÂ¢ÃÂÃÂ Add to Calendar</button>
                        <button onClick={()=>dismiss(i)} style={{flex:1,padding:"9px",borderRadius:8,background:"#45090a55",border:"1px solid #EF444444",color:"#EF4444",fontSize:12,cursor:"pointer",fontWeight:700}}>ÃÂ¢ÃÂÃÂ Skip</button>
                      </div>
                    ):(
                      <div style={{textAlign:"center",fontSize:10,color:"#374151"}}>Skipped ÃÂÃÂ· <span onClick={()=>undismiss(i)} style={{color:"#3B82F6",cursor:"pointer"}}>Undo</span></div>
                    )}
                  </div>
                </div>
              );
            ...
            {active.length>1&&(
              <div style={{marginTop:12,paddingTop:12,borderTop:"1px solid #1e2d4a"}}>
                <button onClick={()=>onAddBids(active)} style={{width:"100%",padding:"13px",borderRadius:10,background:"#F59E0B",border:"none",color:"#000",fontSize:14,cursor:"pointer",fontWeight:900}}>ÃÂ¢ÃÂÃÂ Add All {active.length} to Calendar</button>
              </div>
            )}
            <div style={{textAlign:"center",marginTop:12}}><button onClick={runScan} style={{background:"transparent",border:"none",color:"#475569",fontSize:10,cursor:"pointer"}}>ÃÂ¢ÃÂÃÂ³ Rescan</button></div>
          </>
        )}
      </div>
    </div>
...
function EstimatingCalendar({ bids, onUpdateBid, onScanBids }) {
  ...
  // Map bidDue ÃÂ¢ÃÂÃÂ list of bids for that YYYY-MM-DD
    ...
    <div style={{display:"flex",flexDirection:"column",height:"100%",overflow:"hidden"}}>
      ...
      <div style={{background:"#080d18",borderBottom:"1px solid #1e2d4a",padding:"12px 16px",flexShrink:0}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
          ...
          <button onClick={()=>setShowScan(true)} style={{padding:"7px 14px",borderRadius:8,background:"#1a0e0088",border:"1px solid #F59E0B55",color:"#F59E0B",fontSize:10,cursor:"pointer",fontWeight:700,whiteSpace:"nowrap"}}>ÃÂ°ÃÂÃÂÃÂ Scan Emails</button>
        </div>
        ...
        {urgentBids.length>0&&(
          <div style={{background:"#45090a22",border:"1px solid #EF444433",borderRadius:8,padding:"7px 10px",marginBottom:10}}>
            <div style={{fontSize:8,color:"#EF4444",letterSpacing:1.5,textTransform:"uppercase",marginBottom:3}}>ÃÂ¢ÃÂÃÂ  {urgentBids.length} bid{urgentBids.length!==1?"s":""} due within 7 days</div>
            {urgentBids.slice(0,3).map(b=>{
              const d=daysUntil(b.bidDue);
              return <div key={b.id} onClick={()=>setDetailBid(b)} style={{fontSize:10,color:"#FCA5A5",marginTop:2,cursor:"pointer"}}>ÃÂÃÂ· {b.projectName} ÃÂ¢ÃÂÃÂ {d<0?"OVERDUE":d===0?"TODAY":d+"d"}</div>;
            })}
          </div>
        )}
        ...
        <div style={{display:"flex",gap:0,background:"#0c1422",border:"1px solid #1e2d4a",borderRadius:8,overflow:"hidden"}}>
          {[{id:"calendar",label:"ÃÂ°ÃÂÃÂÃÂ Calendar"},{id:"list",label:"ÃÂ¢ÃÂÃÂ° List"}].map(v=>(
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ CALENDAR VIEW ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      {viewMode==="calendar"&&(
        <div style={{flex:1,overflowY:"auto",padding:"0 0 100px"}}>
          {/* Month nav */}
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 16px 8px"}}>
            <button onClick={prevMonth} style={{width:34,height:34,borderRadius:"50%",background:"#0c1422",border:"1px solid #1e2d4a",color:"#94A3B8",fontSize:16,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}}>ÃÂ¢ÃÂÃÂ¹</button>
            ...
            <button onClick={nextMonth} style={{width:34,height:34,borderRadius:"50%",background:"#0c1422",border:"1px solid #1e2d4a",color:"#94A3B8",fontSize:16,cursor:"pointer",display:"flex",alignItems:"center",justifyContent:"center"}}>ÃÂ¢ÃÂÃÂº</button>
          </div>
                      ...
                      {dayBids.slice(0,3).map((b,bi)=>{
                        ...
                        return(
                          <div key={bi} style={{background:uc+"22",border:`1px solid ${uc}44`,borderRadius:3,padding:"1px 3px",marginBottom:1}}>
                            <div style={{fontSize:7,fontWeight:700,color:uc,lineHeight:1.3,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{b.projectName.split("ÃÂ¢ÃÂÃÂ")[0].split("-")[0].trim()}</div>
                          </div>
                        );
                      })}
          ...
          {selectedDay&&(
            <div style={{margin:"12px 10px 0",padding:"14px",background:"#0a0f1c",border:"1px solid #1e2d4a",borderRadius:12}}>
              <div style={{fontSize:9,color:"#F59E0B",letterSpacing:2,textTransform:"uppercase",marginBottom:8}}>
                {MONTH_NAMES[calMonth]} {selectedDay}, {calYear} ÃÂÃÂ· {selectedDayBids.length} bid{selectedDayBids.length!==1?"s":""}
              </div>
              {selectedDayBids.length===0?(
                ...
                return(
                  <div key={b.id} onClick={()=>setDetailBid(b)}
                    ...
                    {b.assignedTo&&b.assignedTo!=="Assign ÃÂ¢ÃÂÃÂ"&&<div style={{fontSize:8,color:"#374151",marginTop:3}}>ÃÂ°ÃÂÃÂÃÂ¤ {b.assignedTo}</div>}
                    <div style={{marginTop:6,fontSize:9,color:"#3B82F6"}}>Tap to open ÃÂ¢ÃÂÃÂ</div>
                  </div>
                );
              })}
            </div>
          ...
          <div style={{margin:"12px 10px 0",display:"flex",gap:10,flexWrap:"wrap"}}>
            {[{c:"#EF4444",l:"ÃÂ¢ÃÂÃÂ¤2 days"},{c:"#F59E0B",l:"ÃÂ¢ÃÂÃÂ¤7 days"},{c:"#10B981",l:">7 days"}].map(x=>(
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ LIST VIEW ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      {viewMode==="list"&&(
        <div style={{flex:1,overflowY:"auto",padding:"12px 16px 100px"}}>
          ...
          {sortedList.length===0?(
            <div style={{textAlign:"center",paddingTop:40,color:"#1e2d4a",fontSize:12}}>
              {bids.length===0?"No bids yet ÃÂ¢ÃÂÃÂ tap Scan Emails to pull from inbox":"Nothing in this filter"}
            </div>
          ):sortedList.map(bid=>{
            ...
            return(
              <div key={bid.id} onClick={()=>setDetailBid(bid)}
                ...
                {bid.projectAddress&&<div style={{fontSize:9,color:"#475569",marginBottom:5}}>ÃÂ°ÃÂÃÂÃÂ {bid.projectAddress}</div>}
                {bid.scope&&<div style={{fontSize:9,color:"#64748B",marginBottom:5}}>ÃÂ°ÃÂÃÂÃÂ {bid.scope}</div>}
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"6px 8px",background:"#080d16",borderRadius:6}}>
                  ...
                  {days!==null&&(
                    <div style={{textAlign:"right"}}>
                      <div style={{fontSize:20,fontWeight:900,color:uc,lineHeight:1}}>{days<0?"ÃÂ¢ÃÂÃÂ ":days}</div>
                      <div style={{fontSize:7,color:uc}}>{days<0?"overdue":days===0?"today":"days"}</div>
                    </div>
                  )}
                </div>
                {bid.assignedTo&&bid.assignedTo!=="Assign ÃÂ¢ÃÂÃÂ"&&<div style={{fontSize:8,color:"#475569",marginTop:5}}>ÃÂ°ÃÂÃÂÃÂ¤ {bid.assignedTo}</div>}
              </div>
            );
          })}
        </div>
...
export default function App() {
  ...
  useEffect(()=>{
    (async()=>{
      // 1. Load tasks ÃÂ¢ÃÂÃÂ Firebase is source of truth, local storage is fallback
  ...
  const addBids = newBids => {
    setBids(p=>[...p,...newBids.map(b=>({...b,id:"bid-"+Date.now()+Math.random()*999|0,status:b.status||"NEW",assignedTo:b.assignedTo||"Assign ÃÂ¢ÃÂÃÂ",notes:b.notes||""}))]);
  };
  ...
  if (!loaded) return (
    <div style={{background:"#060a12",height:"100vh",display:"flex",alignItems:"center",justifyContent:"center"}}>
      <div style={{textAlign:"center"}}>
        <div style={{fontSize:28,marginBottom:12}}>ÃÂ°ÃÂÃÂÃÂ</div>
  ...
  return (
    <div style={{fontFamily:"'DM Sans','Segoe UI',system-ui,sans-serif",background:"#060a12",height:"100vh",display:"flex",flexDirection:"column",color:"#F1F5F9",overflow:"hidden"}}>
      ...
      {/* ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ TOP NAV ÃÂ¢ÃÂÃÂÃÂ¢ÃÂÃÂ */}
      <div style={{background:"#080d18",borderBottom:"1px solid #1e2d4a",padding:"9px 14px",display:"flex",alignItems:"center",justifyContent:"space-between",flexShrink:0}}>
        <div>
          <div style={{fontSize:7,letterSpacing:2.5,color:"#3B82F6",textTransform:"uppercase"}}>Coastal Plumbing ÃÂÃÂ· SWFL</div>
          <div style={{fontSize:15,fontWeight:900,letterSpacing:-0.5}}>OPS CENTER</div>
        </div>
        <div style={{display:"flex",gap:5,alignItems:"center"}}>
          <div style={{fontSize:8,color:calLoading?"#F59E0B":calEvents.length>0?"#10B981":"#EF4444"}}>{calLoading?"ÃÂ¢ÃÂÃÂ³":calEvents.length>0?`ÃÂ°ÃÂÃÂÃÂ${calEvents.length}`:"ÃÂ°ÃÂÃÂÃÂ0"}</div>
          <div onClick={refreshFromFirebase} title="Firebase sync" style={{fontSize:8,cursor:"pointer",color:fbStatus==="synced"?"#10B981":fbStatus==="syncing"?"#F59E0B":"#EF4444",background:fbStatus==="synced"?"#052e1644":fbStatus==="syncing"?"#1c100344":"#45090a44",border:`1px solid ${fbStatus==="synced"?"#10B98133":fbStatus==="syncing"?"#F59E0B33":"#EF444433"}`,borderRadius:4,padding:"2px 6px",fontWeight:700}}>
            {fbStatus==="synced"?"ÃÂ°ÃÂÃÂÃÂ¥ LIVE":fbStatus==="syncing"?"ÃÂ¢ÃÂÃÂ³ SYNCÃÂ¢ÃÂÃÂ¦":"ÃÂ¢ÃÂÃÂ  FB ERR"}
          </div>
          <button onClick={refreshCal} style={{padding:"4px 7px",borderRadius:5,background:"#111827",border:"1px solid #1e2d4a",color:"#475569",fontSize:10,cursor:"pointer"}}>ÃÂ¢ÃÂÃÂ³</button>
          <button onClick={()=>setShowBriefing(true)} style={{padding:"5px 9px",borderRadius:5,background:"#0d2818",border:"1px solid #10B98133",color:"#10B981",fontSize:10,cursor:"pointer",fontWeight:700}}>ÃÂ¢ÃÂÃÂ</button>
          {tab!=="bids"&&<button onClick={()=>setShowEmailScan(true)} style={{padding:"5px 9px",borderRadius:5,background:"#0d1628",border:"1px solid #3B82F644",color:"#93C5FD",fontSize:9,cursor:"pointer",fontWeight:700}}>ÃÂ°ÃÂÃÂÃÂ§</button>}
      ...
      {/* Stats bar ÃÂ¢ÃÂÃÂ hide on bids tab (has its own) */}
      {tab!=="bids"&&(
      ...
      {/* Quick Capture ÃÂ¢ÃÂÃÂ hide on bids tab */}
      {tab!=="bids"&&<QuickCapture onAdd={addTask}/>}

      {/* Week strip ÃÂ¢ÃÂÃÂ today only */}
      ...
      <div style={{background:"#080d18",borderTop:"1px solid #1e2d4a",display:"flex",padding:"7px 0 env(safe-area-inset-bottom,7px)",flexShrink:0}}>
        {[
          {id:"today",      icon:"ÃÂ°ÃÂÃÂÃÂ", label:"Today"},
          {id:"queue",      icon:"ÃÂ¢ÃÂÃÂ¡", label:"Queue",  badge:unscheduled.length},
          {id:"bids",       icon:"ÃÂ°ÃÂÃÂÃÂÃÂ¯ÃÂ¸ÃÂ", label:"Bids",   badge:urgentBids.length, badgeColor:"#F59E0B", badgeText:"#000"},
          {id:"delegation", icon:"ÃÂ°ÃÂÃÂÃÂ¤", label:"Team",   badge:delegated.length},
        ].map(t=>(
